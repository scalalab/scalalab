...
class inspectCompletionListAction() extends javax.swing.AbstractAction() {
  ...
  override def actionPerformed(e: ActionEvent) {
    ...
    scalaExec.Interpreter.GlobalValues.completionIsForSyntaxPane = true // completion is for JSyntaxPane editor (in
    // order to display the completion popup properly)
