...
class RichNumber(v: Double) {
  ...
  // addition of RichNumber and an Eigen .Mat
  final def +(that: scalaSci.jeigen.Mat): scalaSci.jeigen.Mat = {
    var N = that.Nrows
    var M = that.Ncols

    var result = new scalaSci.jeigen.Mat(N, M)
    var r = 0;
    var c = 0
    while (r < N) {
      c = 0
  ...
  // subtraction of an scalaSci.jeigen.Mat from a RichNumber
  final def -(that: scalaSci.jeigen.Mat): scalaSci.jeigen.Mat = {
    var N = that.Nrows
    var M = that.Ncols
  ...
  // multiplication of a RichNumber with a scalaSci.jeigen.Mat
  final def *(that: scalaSci.jeigen.Mat): scalaSci.jeigen.Mat = {
    var N = that.Nrows
    var M = that.Ncols
  ...
  // division of a RichNumber with a  scalaSci.jeigen.Mat. Divides the corresponding number with each of the Mat's
  // element'
  final def /(that: scalaSci.jeigen.Mat): scalaSci.jeigen.Mat = {
    var N = that.Nrows
    var M = that.Ncols
  ...
  // division of a RichNumber with a  scalaSci.CommonMaths.Mat. Divides the corresponding number with each of the
  // CommonMaths's element'
  final def /(that: scalaSci.CommonMaths.Mat): scalaSci.CommonMaths.Mat = {
    var N = that.Nrows
    var M = that.Ncols
