...
object fPlotObj {
  var globalFunction1d: Function1[Double, Double] = _
  // 1-D function
...
object PlotFunctional {
  ...
  def splot(
             expr: String, low: Double, high: Double, color: java.awt.Color = java.awt.Color.RED, linePlotsFlag:
  Boolean = true, nP: Int = 2000): Unit = {
  ...
  def splot2d(
               expr: String, lowx: Double, highx: Double, lowy: Double, highy: Double, color: java.awt.Color = java
    .awt.Color.GREEN,
 ...
 */
  ...
  def fplot(
             f1d: Double => Double, low: Double, high: Double, color: java.awt.Color = java.awt.Color.RED,
             linePlotsFlag: Boolean = true, nP: Int = 2000): Unit = {
 ...
 */
  ...
  def fplot2d(
               f2d: (Double, Double) => Double, lowx: Double, highx: Double, lowy: Double, highy: Double,
