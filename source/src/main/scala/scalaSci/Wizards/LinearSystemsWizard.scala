...
var a = $$(1.0,  -1.0,  -1.0,   -1,   -1, null,   -1, 2,  0,   0,   0, null,   -1,  0,  3,  1, 1, null,    -1,  0, 1,
  4,  2, null,     -1,  0,  1,  2, 5) // whatever your matrix is
...
var minSingularValue = -1.0 // below which singular values are ignored, a 0 or negative value implies all singular
values will be used
...
var a = $$(1.0,  -1.0,  -1.0,   -1,   -1, null,  -1, 2,  0,   0,   0, null,  -1,  0,  3,  1, 1, null,  -1,  0, 1,  4,
  2, null,    -1,  0,  1,  2, 5) // whatever your matrix is
...
var lA = new RDDA(choleskyObj.getL.getData)  // get the matrix  L of the decomposition as a RDDA
   ...
   */
       var a = $$(2.3, 0.2, 0.4, 0.45, null, 1.1, -1.1, 0.34, 0.2, null, 0.34, 4.5, 2.3, 1.1, null, 0.1, 0.2, 0.55, 3
       .4)  // the matrix
