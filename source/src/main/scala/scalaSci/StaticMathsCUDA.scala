...
object StaticMathsCUDA extends AnyRef with scalaSci.StaticScalaSciCommonOps[scalaSci.CUDAMat] with
scalaSci.StaticScalaSciGlobal {

  implicit final def vecToMat(x: Vec): scalaSci.Mat = {
    vec2Mat(x)
  }

  // implicit conversion of a Vec to Mat
  implicit final def MatToDoubleArr(x: scalaSci.Mat) = {
    x.getRow(0)
  }
  ...
  def LU_solve(A: scalaSci.CUDAMat, b: scalaSci.CUDAMat): scalaSci.CUDAMat = {
    new CUDAMat(1, 1)
  }

  def corr(A: scalaSci.CUDAMat, B: scalaSci.CUDAMat): scalaSci.CUDAMat = {
    new CUDAMat(1, 1)
  }

  def correlation(A: scalaSci.CUDAMat, B: scalaSci.CUDAMat): scalaSci.CUDAMat = {
    new CUDAMat(1, 1)
  }

  def cov(A: scalaSci.CUDAMat, B: scalaSci.CUDAMat): scalaSci.CUDAMat = {
    new CUDAMat(1, 1)
  }

  def covariance(A: scalaSci.CUDAMat, B: scalaSci.CUDAMat): scalaSci.CUDAMat = {
    new CUDAMat(1, 1)
  }

  def find(A: scalaSci.CUDAMat): Array[Array[Int]] = {
    Array.ofDim[Int](1, 1)
  }
