...
object XYDataset {
  def apply[Item](
                   name: String, items: IndexedSeq[Item], x: Item => Number, y: Item => Number, label: Item => String,
                   tip: Item => String)
  : XYDataset[Item] = {
...
class XYZDataset[Item](
                        x: Item => Number, y: Item => Number, z: Item => Number, label: Item => String, tip: Item =>
  String)
...
object XYZDataset {
  def apply[Item](
                   name: String, items: IndexedSeq[Item], x: Item => Number, y: Item => Number, z: Item => Number,
                   label: Item => String, tip: Item => String)
  : XYZDataset[Item] = {
