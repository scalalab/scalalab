...
object scalaBind {
  ...
  def bind(varName: String, varValue: AnyRef) = {
    ...
    if (varValue.isInstanceOf[BigDecimal]) {
      ...
      scalaExec.Interpreter.GlobalValues.double2DArrayValForBinding = (varValue.asInstanceOf[Array[Array[Double]]])
        .clone
      ...
      scalaExec.Interpreter.GlobalValues.matlabComplexForBinding = (varValue.asInstanceOf[scalaExec.Interpreter
      .MatlabComplex])
