...
object importHelper {
  ...
  def injectJavaSwing() = {
    val javaSwingStr = "\n importJavaSwing \n\n"
    scalaExec.Interpreter.GlobalValues.editorPane.setText(javaSwingStr + scalaExec.Interpreter.GlobalValues
      .editorPane.getText)
  }
  ...
  def injectBasicPlots() = {
    val basicPlotsStr = "\n importBasicPlots \n\n"
    scalaExec.Interpreter.GlobalValues.editorPane.setText(basicPlotsStr + scalaExec.Interpreter.GlobalValues
      .editorPane.getText)
  }
  ...
  def injectNumAl() = {
    val numAlStr = "\n importNumAl \n\n"
    scalaExec.Interpreter.GlobalValues.editorPane.setText(numAlStr + scalaExec.Interpreter.GlobalValues.editorPane
      .getText)
  }
...
import _root_.scalaSci.Vec;
  ...
  def injectScalaSciMTJMatDirectly = {
    val mtjStr = """
        ...
        import _root_.scalaSci.MTJ.StaticMathsMTJ._ ;
                 """
    scalaExec.Interpreter.GlobalValues.editorPane.setText(mtjStr + scalaExec.Interpreter.GlobalValues.editorPane
      .getText)
  ...
  def injectJPlots() = {
    val jplotStr = "\n importJPlots\n\n"
    scalaExec.Interpreter.GlobalValues.editorPane.setText(jplotStr + scalaExec.Interpreter.GlobalValues.editorPane
      .getText)
  }
  ...
  def injectJPlotsDirectly = {
    val jplotsStr = """
            ...
            import _root_.JFplot.jFigure._;
                    ...
                    """
    scalaExec.Interpreter.GlobalValues.editorPane.setText(jplotsStr + scalaExec.Interpreter.GlobalValues.editorPane
      .getText)
  }
  ...
  def injectLAPACK() = {
    val LAPACKStr = "\n importLAPACK\n\n"
    scalaExec.Interpreter.GlobalValues.editorPane.setText(LAPACKStr + scalaExec.Interpreter.GlobalValues.editorPane
      .getText)
  }
  ...
  def injectComputerAlgebra() = {
    ...
    scalaExec.Interpreter.GlobalValues.editorPane.setText(computerAlgebraStr + scalaExec.Interpreter.GlobalValues
      .editorPane.getText)
  }
  ...
  def injectApacheCommons() = {
    ...
    scalaExec.Interpreter.GlobalValues.editorPane.setText(apacheCommonsStr + scalaExec.Interpreter.GlobalValues
      .editorPane.getText)
  }
