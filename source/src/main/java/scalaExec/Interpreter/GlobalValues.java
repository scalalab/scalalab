...
public class GlobalValues {
    ...
    static public String scalalabBuildVersion = "09-July-15";
    ...
    static public JEditorPane editorPane; // the jsyntax[ane based editor
    ...
    static public String editFrameLocX = "100";
    static public String editFrameLocY = "100";
    static public String editFrameSizeX = "600";
    static public String editFrameSizeY = "600";
    ...
    static public String interpreterType() {
        ...
        switch (interpreterTypeForPane) {
            ...
            case NotAnyImports:
                return "  not using any imports";

            default:
                return "Uknown library";
        }
