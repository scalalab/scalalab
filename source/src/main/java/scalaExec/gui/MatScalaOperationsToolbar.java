...
public class MatScalaOperationsToolbar extends JPanel {
    JButton bmatrixAccess, bdirect, bconstr, bsubm, bsubmr, bsubmc, bdotProduct;
    ...
    public MatScalaOperationsToolbar() {
...
//    bLU_U
        ...
        matrixPanel6.add(bdet);
        matrixPanel6.add(blu);
        matrixPanel6.add(bsvd);
