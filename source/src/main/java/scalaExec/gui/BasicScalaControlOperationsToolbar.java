...
public class BasicScalaControlOperationsToolbar extends JPanel {
    ...
    public BasicScalaControlOperationsToolbar() {
        ...
        controlPanel.add(bexec);
        controlPanel.add(bclearAll);
        controlPanel.add(bcloseAll);
        controlPanel.add(bwhos);
        controlPanel.add(bdir);
        controlPanel.add(bcd);
        controlPanel.add(bmd);
        controlPanel.add(bcls);
