...
public class CalculusScalaToolbar extends JPanel {
    ...
    public CalculusScalaToolbar() {
        ...
        basicCalculusPanel.add(bqadrat);
        basicCalculusPanel.add(bintegral);
        basicCalculusPanel.add(btricub);
        basicCalculusPanel.add(breccof);
        basicCalculusPanel.add(bjacobnnf);
        basicCalculusPanel.add(bjacobnmf);
