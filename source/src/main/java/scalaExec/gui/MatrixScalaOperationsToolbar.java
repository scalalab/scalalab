...
public class MatrixScalaOperationsToolbar extends JPanel {
    JButton bmatrixAccess, bconstr, bdirect, bcolon, bsubm, bsubmr, bsubmc, bdotProduct;
    JButton bones, bzeros, brand, beye, btrans, binv, butriag, breshape;
    JButton bsum, bdet, beig2, blu, bsvd, bqr;
    JButton bsin, bcos, btan, basin, bacos, batan, bsinh, bcosh, btanh;
    JButton btoMat, btoMatrix, vecToMatrix, bmap;
    JButton binplace, brightAssoc, browAppend, browPrepend, bcolAppend, bcolPrepend;
    JButton bnormInf, bnorm1, bnorm2, bnormF;


    public MatrixScalaOperationsToolbar() {
        ...
        matrixPanel2.add(bones);
        matrixPanel2.add(bzeros);
        matrixPanel2.add(brand);
        matrixPanel2.add(beye);
        matrixPanel2.add(btrans);
        matrixPanel2.add(binv);
        matrixPanel2.add(breshape);
        matrixPanel2.add(bsum);
        matrixPanel2.add(bdet);
        matrixPanel2.add(beig2);
        matrixPanel2.add(blu);
        matrixPanel2.add(bsvd);
        matrixPanel2.add(bqr);


        matrixPanel3.add(bsin);
        matrixPanel3.add(bcos);
        matrixPanel3.add(btan);
        matrixPanel3.add(basin);
        matrixPanel3.add(bacos);
        matrixPanel3.add(batan);
        matrixPanel3.add(bsinh);
        matrixPanel3.add(bcosh);
        matrixPanel3.add(btanh);
        ...
        matrixPanel4.add(binplace);
        matrixPanel4.add(brightAssoc);
        matrixPanel4.add(browAppend);
        matrixPanel4.add(browPrepend);
        matrixPanel4.add(bcolAppend);
        matrixPanel4.add(bcolPrepend);
