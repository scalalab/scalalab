...
public class VecScalaOperationsToolbar extends JPanel {
    ...
    public VecScalaOperationsToolbar() {
        ...
        vectorPanel1.add(bcolon);
        vectorPanel1.add(bhelp);
        vectorPanel1.add(bconstr);
        vectorPanel1.add(bdirect);
        vectorPanel1.add(blinspace);
        vectorPanel1.add(blogspace);

        vectorPanel2.add(bsubv);
        vectorPanel2.add(bdotProduct);
        vectorPanel2.add(bones);
        vectorPanel2.add(bzeros);
        vectorPanel2.add(bfill);
        vectorPanel2.add(brand);
        vectorPanel2.add(bsum);

        vectorPanel3.add(babs);
        vectorPanel3.add(bmean);
        vectorPanel3.add(bmin);
        vectorPanel3.add(bmax);
        vectorPanel3.add(bceil);
        vectorPanel3.add(bfloor);
        vectorPanel3.add(bsqrt);

        vectorPanel4.add(blog);
        vectorPanel4.add(bexp);
        vectorPanel4.add(bsin);
        vectorPanel4.add(bcos);
        vectorPanel4.add(btan);
        vectorPanel4.add(basin);
        vectorPanel4.add(bacos);
        vectorPanel4.add(batan);

        vectorPanel5.add(bsinh);
        vectorPanel5.add(bcosh);
        vectorPanel5.add(btanh);
        vectorPanel5.add(binplace);
        vectorPanel5.add(brightAssoc);
        vectorPanel5.add(bscalarAppend);
        vectorPanel5.add(bscalarPrepend);

        vectorPanel6.add(bscalarAppendLA);
        vectorPanel6.add(bscalarPrependLA);
        vectorPanel6.add(bvectorAppend);
        vectorPanel6.add(bvectorPrepend);
        vectorPanel6.add(bmap);
        vectorPanel6.add(bfft);
