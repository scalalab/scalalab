...
public class LAScalaToolbar extends JPanel {
    ...
    public LAScalaToolbar() {
        ...
        la1Panel.add(bdecsol);
        la1Panel.add(bgsssol);
        la1Panel.add(bgsssolerb);
        la1Panel.add(bdecinv);
        la1Panel.add(bgssinv);
        la1Panel.add(bgssinverb);
        la1Panel.add(bgssitisol);
        la1Panel.add(bgssitisolerb);
        la1Panel.add(bchol1);
        la1Panel.add(bchol2);
        la1Panel.add(bcholdec1);
        la1Panel.add(bcholdec2);

        la2Panel.add(bdetermSym2);
        la2Panel.add(bdecsolsym2);
        la2Panel.add(blsqsol);
        la2Panel.add(blsqortdecsol);
        la2Panel.add(blsqinv);
        la2Panel.add(blsqdecomp);
        la2Panel.add(bsolovr);
        la2Panel.add(bsolund);
        la2Panel.add(bhomsol);
        la2Panel.add(bpsdinv);

        la3Panel.add(bdetermbnd);
        la3Panel.add(bdecsolbnd);
        la3Panel.add(bsoltripiv);
        la3Panel.add(bdecsoltripiv);
        la3Panel.add(bchlsolbnd);
        la3Panel.add(bdecsolsymtri);

        la4Panel.add(bconjgrad);
        la4Panel.add(beqilbrcom);
        la4Panel.add(bhshhrmtri);
        la4Panel.add(bvalsymtri);
        la4Panel.add(beigsym1);
        la4Panel.add(bsymeigimp);
        la4Panel.add(bcomvalqri);
        la4Panel.add(breaeig3);

        la5Panel.add(beighrm);
        la5Panel.add(bqrihrm);
        la5Panel.add(bvalqricom);
        la5Panel.add(bqricom);
        la5Panel.add(beigcom);
        la5Panel.add(bqzival);
        la5Panel.add(bqzi);
        la5Panel.add(bqrisngvaldec);
