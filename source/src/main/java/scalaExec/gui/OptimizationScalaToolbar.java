...
public class OptimizationScalaToolbar extends JPanel {
    ...
    public OptimizationScalaToolbar() {
        ...
        zeroFindingPanel.add(bzeroin);
        zeroFindingPanel.add(bzeroinrat);
        zeroFindingPanel.add(bzeroinder);
        zeroFindingPanel.add(bquanewbnd1);

        minPanel.add(bminin);
        minPanel.add(bmininder);
        minPanel.add(bpraxis);
        overdeterminedPanel.add(bmarquardt);
        overdeterminedPanel.add(bgssnewton);

        allOptimizationPanel.add(zeroFindingPanel);
        allOptimizationPanel.add(minPanel);
        allOptimizationPanel.add(overdeterminedPanel);
