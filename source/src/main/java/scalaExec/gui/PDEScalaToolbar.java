...
public class PDEScalaToolbar extends JPanel {
    ...
    public PDEScalaToolbar() {
        ...
        pde1Panel.add(bfemlagsym);
        pde1Panel.add(bfemlag);
        pde1Panel.add(bfemlagspher);
        pde2Panel.add(bfemlagskew);
        pde2Panel.add(bfemhermsym);
        pde2Panel.add(bnonlinfemlagskew);
        pde3Panel.add(brichardson);
        pde3Panel.add(belimination);
        pde3Panel.add(bpeide);
