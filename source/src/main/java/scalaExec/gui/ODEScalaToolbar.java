...
public class ODEScalaToolbar extends JPanel {
    ...
    public ODEScalaToolbar() {
        ...
        ode1Panel.add(brke);
        ode1Panel.add(brk4a);
        ode1Panel.add(brk4na);
        ode1Panel.add(brk5na);
        ode2Panel.add(bmultistep);
        ode2Panel.add(bdiffsys);
        ode2Panel.add(bark);
        ode2Panel.add(befrk);
        ode2Panel.add(befsirk);
        ode2Panel.add(bliniger1vs);
        ode2Panel.add(blininger2vs);
        ode3Panel.add(bgms);
        ode3Panel.add(bimpex);
        ode3Panel.add(bmodifiedTaylor);
        ode3Panel.add(beft);
        ode3Panel.add(brk2);
        ode3Panel.add(brk2n);
        ode3Panel.add(brk3);
        ode3Panel.add(brk3n);
        ode3Panel.add(barkmat);
