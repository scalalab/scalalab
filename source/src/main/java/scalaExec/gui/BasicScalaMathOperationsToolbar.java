...
public class BasicScalaMathOperationsToolbar extends JPanel {
    ...
    public BasicScalaMathOperationsToolbar() {
        ...
        basicPanel.add(bcos);
        basicPanel.add(btan);
        basicPanel.add(basin);
        basicPanel.add(bacos);
        basicPanel.add(batan);
        basicPanel.add(bsinh);
        basicPanel.add(bcosh);
        basicPanel.add(btanh);
        basicPanel.add(basinh);
        basicPanel.add(bacosh);
        basicPanel.add(batanh);

        basicPanel.add(babs);
        basicPanel.add(bceil);
        basicPanel.add(bfloor);
        basicPanel.add(bsqrt);
        basicPanel.add(blog);
        basicPanel.add(bln);
        basicPanel.add(bexp);
