...
public class ProcessNumAlInJar extends JFrame {
    ...
    public ProcessNumAlInJar(String jarFile) {
        setTitle("NUMAL Examples ");
        ...
        examplesLabel.setText("Selected NUMAL example: ");
