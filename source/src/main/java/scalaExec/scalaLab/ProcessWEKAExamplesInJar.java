...
public class ProcessWEKAExamplesInJar extends JFrame {
    ...
    public ProcessWEKAExamplesInJar(String jarFile) {
        setTitle("Wavelet  Examples -- Copy & Paste to run them ");
        ...
        examplesLabel.setText("Selected WEKA example - Requires WEKA toolbox to be loaded: ");
    ...
    public void scanJarFile() {
        ...
        try {
            ...
            while ((entry = zin.getNextJarEntry()) != null) {
                ...
                if (nameOfEntry.endsWith(".weka-ssci"))
