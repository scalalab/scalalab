...
public class ProcessLinearAlgebraExamplesInJar extends JFrame {
    ...
    public ProcessLinearAlgebraExamplesInJar(String jarFile) {
        setTitle("Linear Algebra Examples -- Copy & Paste to run them ");
        ...
        examplesLabel.setText("Selected Linear Algebra example: ");
    ...
    public void scanJarFile() {
        ...
        try {
            ...
            while ((entry = zin.getNextJarEntry()) != null) {
                ...
                if (nameOfEntry.endsWith(".la-ssci"))
