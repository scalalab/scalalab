...
public class ProcessPlottingExamplesInJar extends JFrame {
    ...
    public ProcessPlottingExamplesInJar(String jarFile) {
        setTitle("Plotting  Examples -- Copy & Paste the code in the console to run them");
    ...
    public void scanJarFile() {
        ...
        try {
            ...
            while ((entry = zin.getNextJarEntry()) != null) {
                ...
                if (nameOfEntry.endsWith(".plots-ssci"))
