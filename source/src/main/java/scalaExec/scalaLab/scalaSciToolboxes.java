            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (retVal == JFileChooser.APPROVE_OPTION) {   // approve toolbox
                    ...
                    for (int k = 0; k < selectedFiles.length; k++) {  // for all selected files
                        ...
                        if (jarFileName.endsWith(".jar")) {  // if toolbox is not already specified insert it to the list of available toolboxes
...
class updateSystemWithJarToolboxesNewInterpreter extends AbstractAction {
    updateSystemWithJarToolboxesNewInterpreter() {
        super("Update system with jar toolboxes creating a new Interpreter ");
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (GlobalValues.scalaJarClassesLoaded == false) {   // the classes of the toolboxes for Scala were not loaded
            ...
            for (int k = 0; k < numToolboxes; k++) {  // for all toolboxes for ScalaSci
                ...
                if (GlobalValues.ScalaSciClassPathComponents.contains(forScalaToolboxJarName) == false) {    // path not already exist in ScalaSciClassPath
                ...
                if (GlobalValues.ScalaSciToolboxes.contains(forScalaToolboxJarName) == false) {    // path not already exist in ScalaSciUserPaths
...
class updateSystemWithJarToolboxesNewEJMLInterpreter extends AbstractAction {
    updateSystemWithJarToolboxesNewEJMLInterpreter() {
        super("Update system with jar toolboxes creating a new Interpreter based on EJML library ");
    }
