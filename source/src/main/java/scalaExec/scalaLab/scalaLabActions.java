...
class ODEWizardscalaSciAction extends AbstractAction {
    ODEWizardscalaSciAction() {
        super("ODE Wizard ScalaSci - Java based ODE implementations");
    }
...
class ODEWizardscalaSciScalaAction extends AbstractAction {
    ODEWizardscalaSciScalaAction() {
        super("ODE Wizard ScalaSci - Scala based ODE implementations");
    }
...
class fastScriptAction extends AbstractAction {
    public fastScriptAction() {
        super("Generate template for fast script");
    }
...
class jeditAction extends AbstractAction {
    public jeditAction() {
        super("jEdit Editor - supports Scala editing if you name the files with .scala extension");
    }
...
class editDSPAction extends AbstractAction {
    public editDSPAction() {
        super("scalaLab Editor DSP Application");
    }
...
class simpleJavaApplAction extends AbstractAction {
    public simpleJavaApplAction() {
        super("simple Java Application ");
    }
...
class scalaClassWithCompanionObject extends AbstractAction {
    public scalaClassWithCompanionObject() {
        super("Scala Class with Companion object");
    }
...
class scalaStandAloneObject extends AbstractAction {
    public scalaStandAloneObject() {
        super("Scala StandAlone object");
    }
...
class simpleJavaApplUsingScalaLabAction extends AbstractAction {
    public simpleJavaApplUsingScalaLabAction() {
        super("simple Java Application using the scalaLab libraries");
    }
...
class simpleJavaApplUsingScalaLabBioJavaAction extends AbstractAction {
    public simpleJavaApplUsingScalaLabBioJavaAction() {
        super("simple Java Application using the scalaLab libraries and the BioJava toolbox");
    }
...
class simpleScalaApplAction extends AbstractAction {
    public simpleScalaApplAction() {
        super("simple Scala Application ");
    }
...
class simpleScalaApplUsingScalaLabAction extends AbstractAction {
    public simpleScalaApplUsingScalaLabAction() {
        super("simple Scala Application using the scalaLab libraries");
    }
...
class simpleScalaApplUsingScalaLabBioJavaAction extends AbstractAction {
    public simpleScalaApplUsingScalaLabBioJavaAction() {
        super("simple Scala Application using the scalaLab libraries and the BioJava Toolbox");
    }
...
class compileScalaSciScriptsOnScalaSciClasspathAction extends AbstractAction {
    compileScalaSciScriptsOnScalaSciClasspathAction() {
        super("Compile ScalaSci Scripts on the default ScalaSciClassPath");
    }
...
class configureScalaInterpreterAction extends AbstractAction {
    configureScalaInterpreterAction() {
        super("Configure Scala Interpreter");
    }
                    ...
                    if (selectedIndex >= 0 && toolboxesListSize > 0) {  // currently exist a selected toolbox for removal
                        ...
                        if (scalaSciToolboxes.ssciToolboxes != null) {  // already loaded toolboxes
                            ...
                            for (int toolboxIdx = 0; toolboxIdx < loadedToolboxesCnt; toolboxIdx++) {  // search for the selected toolbox
                                ...
                                if (currentToolboxName.equalsIgnoreCase(toolboxName) == true) {    // selected toolbox detected at the table, so remove it
