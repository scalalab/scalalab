...
public class ProcessScalaFilesInJar extends JFrame {
    ...
    public ProcessScalaFilesInJar(String jarFile) {
        setTitle("Available Scala and ScalaSci Examples within the scalaLab executable ");
    ...
    public void scanJarFile() {
        ...
        try {
            ...
            while ((entry = zin.getNextJarEntry()) != null) {
                ...
                if (nameOfEntry.endsWith(".scala") || nameOfEntry.endsWith(".ssci"))
