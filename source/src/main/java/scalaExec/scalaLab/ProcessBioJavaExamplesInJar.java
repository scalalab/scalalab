...
public class ProcessBioJavaExamplesInJar extends JFrame {
    ...
    public ProcessBioJavaExamplesInJar(String jarFile) {
        setTitle("BioJava  Examples -- Copy & Paste within  the ScalaLab Editor (Ctrl-E) to compile/run them with the Java Compiler (F5) ");
        ...
        examplesLabel.setText("Selected BioJava example - Requires BioJava toolbox to be loaded: ");
    ...
    public void scanJarFile() {
        ...
        try {
            ...
            while ((entry = zin.getNextJarEntry()) != null) {
                ...
                if (nameOfEntry.endsWith(".biojava") || nameOfEntry.endsWith(".bioscala"))
