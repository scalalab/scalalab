...
public class ProcessScalaInJar extends JFrame {
    ...
    public ProcessScalaInJar(String jarFile) {
        setTitle("Scala Examples -- Copy & Paste ");
        ...
        examplesLabel.setText("Selected Scala  example: ");
    ...
    public void scanJarFile() {
        ...
        try {
            ...
            while ((entry = zin.getNextJarEntry()) != null) {
                ...
                if (nameOfEntry.endsWith(".sscala"))
