...
public class ProcessODEExamplesInJar extends JFrame {
    ...
    public ProcessODEExamplesInJar(String jarFile) {
        setTitle("ODE (Ordinary Differential Equations) Examples -- Copy & Paste to run them ");
        ...
        examplesLabel.setText("Selected ODE example: ");
    ...
    public void scanJarFile() {
        ...
        try {
            ...
            while ((entry = zin.getNextJarEntry()) != null) {
                ...
                if (nameOfEntry.endsWith(".ode-ssci"))
