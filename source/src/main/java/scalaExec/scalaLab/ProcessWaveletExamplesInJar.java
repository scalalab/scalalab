...
public class ProcessWaveletExamplesInJar extends JFrame {
    ...
    public ProcessWaveletExamplesInJar(String jarFile) {
        ...
        examplesLabel.setText("Selected Wavelet example: ");
    ...
    public void scanJarFile() {
        ...
        try {
            ...
            while ((entry = zin.getNextJarEntry()) != null) {
                ...
                if (nameOfEntry.endsWith(".wav-ssci"))
