...
public class ProcessScalaSciInJar extends JFrame {
    ...
    public ProcessScalaSciInJar(String jarFile) {
        ...
        examplesLabel.setText("Selected scalaSci example: ");
