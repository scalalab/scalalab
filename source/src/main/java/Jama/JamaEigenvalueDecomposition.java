...
/*
    ...
    public JamaEigenvalueDecomposition(jMatrix A) {
        this(A.getArray());
    }
     ...
     */
    public JamaEigenvalueDecomposition(double[][] Arg) {
    ...
    public void toCommandLine(String title) {
        System.out.println("EigenValues Decomposition " + title + " :");
        System.out.println("Diagonal matrix\n" + DoubleArray.toString(getD()));
        System.out.println("Projection matrix\n" + DoubleArray.toString(getV()));
    }
}