...
public class DataToolBar extends JToolBar {
    ...
    public DataToolBar(DataPanel dp) {
        ...
        buttonPasteToClipboard = new JButton(new ImageIcon(scalaSci.math.plot.PlotPanel.class.getResource("icons/toclipboard.png")));
        buttonPasteToClipboard.setToolTipText("Copy data to clipboard");

        buttonSaveFile = new JButton(new ImageIcon(scalaSci.math.plot.PlotPanel.class.getResource("icons/tofile.png")));
