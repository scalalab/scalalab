...
*/
    ...
    static public PlotPanel plot(double[] x, double[] y, String typeStr, String name, int lineWidth) {
        ...
        switch (type) {
            case 'b':
                ((Plot2DPanel) currentPlot).addLinePlot(name, Color.BLUE, xy, lineWidth);
                break;
            case 'g':
                ((Plot2DPanel) currentPlot).addLinePlot(name, Color.GREEN, xy, lineWidth);
                break;
            case 'r':
                ((Plot2DPanel) currentPlot).addLinePlot(name, Color.RED, xy, lineWidth);
                break;
            case 'c':
                ((Plot2DPanel) currentPlot).addLinePlot(name, Color.CYAN, xy, lineWidth);
                break;
            case 'm':
                ((Plot2DPanel) currentPlot).addLinePlot(name, Color.MAGENTA, xy, lineWidth);
                break;
            case 'y':
                ((Plot2DPanel) currentPlot).addLinePlot(name, Color.YELLOW, xy, lineWidth);
                break;
            case 'k':
                ((Plot2DPanel) currentPlot).addLinePlot(name, Color.BLACK, xy, lineWidth);
                break;
            case '.':
                ((Plot2DPanel) currentPlot).addLinePlot(name, xy, true);
                break;  // add a dotted plot
            case 'x':
                ((Plot2DPanel) currentPlot).addMarkedLinePlot(name, Color.BLACK, new Font("Arial", Font.BOLD, 12), 'x', xy[0], xy[1]);
                break;
            case '*':
                ((Plot2DPanel) currentPlot).addMarkedLinePlot(name, Color.BLACK, new Font("Arial", Font.BOLD, 12), '*', xy[0], xy[1]);
                break;
            case 'o':
                ((Plot2DPanel) currentPlot).addMarkedLinePlot(name, Color.BLACK, new Font("Arial", Font.BOLD, 12), 'o', xy[0], xy[1]);
                break;
            case 's':
                ((Plot2DPanel) currentPlot).addMarkedLinePlot(name, Color.BLACK, new Font("Arial", Font.BOLD, 12), '*', xy[0], xy[1]);
                break;
            case 'd':
                ((Plot2DPanel) currentPlot).addMarkedLinePlot(name, Color.BLACK, new Font("Arial", Font.BOLD, 12), '\u0101', xy[0], xy[1]);
                break;
            case ':':
                ((Plot2DPanel) currentPlot).addLinePlot(name, Color.GREEN, AbstractDrawer.DOTTED_LINE, lineWidth, xy);
                break;
            case 't':
                ((Plot2DPanel) currentPlot).addLinePlot(name, Color.GREEN, AbstractDrawer.THICK_LINE, (int) AbstractDrawer.lineThickness, xy);
                break;
            case '-':
                ((Plot2DPanel) currentPlot).addLinePlot(name, Color.GREEN, AbstractDrawer.PATTERN_LINE, lineWidth, xy);
                break;
    ...
    static public PlotPanel plot(double[] x, double[] y, Color color, String typeStr, String name, int lineWidth) {
        ...
        switch (type) {
            case 'l':
                ((Plot2DPanel) currentPlot).addLinePlot(name, color, xy, false);
                break;   // a line plot
            case '.':
                ((Plot2DPanel) currentPlot).addLinePlot(name, color, xy, true);
                break;
            case 'x':
                ((Plot2DPanel) currentPlot).addMarkedLinePlot(name, color, new Font("Arial", Font.BOLD, 12), 'x', xy[0], xy[1]);
                break;
            case '*':
                ((Plot2DPanel) currentPlot).addMarkedLinePlot(name, color, new Font("Arial", Font.BOLD, 12), '*', xy[0], xy[1]);
                break;
            case 'o':
                ((Plot2DPanel) currentPlot).addMarkedLinePlot(name, color, new Font("Arial", Font.BOLD, 12), 'o', xy[0], xy[1]);
                break;
            case 's':
                ((Plot2DPanel) currentPlot).addMarkedLinePlot(name, color, new Font("Arial", Font.BOLD, 12), '*', xy[0], xy[1]);
                break;
            case 'd':
                ((Plot2DPanel) currentPlot).addMarkedLinePlot(name, color, new Font("Arial", Font.BOLD, 12), '\u0101', xy[0], xy[1]);
                break;
            case ':':
                ((Plot2DPanel) currentPlot).addLinePlot(name, color, AbstractDrawer.DOTTED_LINE, lineWidth, xy);
                break;
            case 't':
                ((Plot2DPanel) currentPlot).addLinePlot(name, color, AbstractDrawer.THICK_LINE, (int) AbstractDrawer.lineThickness, xy);
                break;
            case '-':
                ((Plot2DPanel) currentPlot).addLinePlot(name, color, AbstractDrawer.PATTERN_LINE, lineWidth, xy);
                break;
