...
public class scalogram extends Plot implements JSci.awt.ColorScheme {
    ...
    private final float c1 = 1;
    private final float c2 = 1;
    private final float c3 = 1;
    private final int Contourx = 1;
    private final int Contoury = 1;
    private int xCoordMax;
    private int yCoordMax;
    private final ColorScheme CS;
    private final double ColorResolution = 60;

    private final int ColorScaleWidth = 20;   // the width of the displayed color scale bar
