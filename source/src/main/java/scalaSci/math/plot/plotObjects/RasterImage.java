...
public class RasterImage implements Plotable {
    ...
    public static void main(String[] args) {
        ...
        p2.addPlotable(new RasterImage(new File("C:\\NBProjects\\scalalab\\scalalabSrc\\scalaSci\\math\\plot\\plotObjects\\test.gif"), 0.8f, new double[]{0.2, 0.5}, new double[]{1.2, 0.8}, new double[]{0.2, 1.1}));
        ...
        p.addPlotable(new RasterImage(new File("C:\\NBProjects\\scalalab\\scalalabSrc\\scalaSci\\math\\plot\\plotObjects\test.gif"), 0.5f, new double[]{0.0, 0.0, 0.0}, new double[]{1, 0, 0.0}, new double[]{0.0, 0, 1}));
        p.addPlotable(new RasterImage(new File("C:\\NBProjects\\scalalab\\scalalabSrc\\scalaSci\\math\\plot\\plotObjects\\test.gif"), 0.5f, new double[]{0.0, 0.0, 0.0}, new double[]{0, 1, 0.0}, new double[]{0, 0.0, 1}));
        p.addPlotable(new RasterImage(new File("C:\\NBProjects\\scalalab\\scalalabSrc\\scalaSci\\math\\plot\\plotObjects\\test.gif"), 0.5f, new double[]{0.0, 0.0, 0.0}, new double[]{1, 0, 0}, new double[]{0, 1, 0}));
